 ...
 *  Главное окно записывает получаемые данные типа LOG в QMap log. По окончанию задания лог сохраняется в папку logs каталога с программой
 *  !!! Больше нигде логи не обрабатываются !!!
 *
